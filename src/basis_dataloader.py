...
#     NOTE : not used stratification here as well
    ...
    test_labeled_TCGA_dataloader = geo_dataLoader(testGraphList, batch_size = batch_size, shuffle =True, drop_last = False, pin_memory=False)
...
def ccle_graphDataLoaders(labeled_CCLE_data, drugFet, drug_gene_inter, gene_gene_inter, batch_size, fetColList, seed):
    ...
    test_labeled_CCLE_dataloader = geo_dataLoader(testGraphList, batch_size = batch_size, shuffle =True,drop_last = False, pin_memory=False)
