...
from mlp import MLP
from encoder_decoder_final import EncoderDecoder, EncoderDecoder_basis
import os
import torch
...
def fine_tune_encoder_basis(encoder, basis_vec, sparse_weight_vec, sparse_weight_vec_flag, train_dataloader, val_dataloader, seed, task_save_folder, inv_temp, test_dataloader=None,
                      metric_name='auroc',
    ...
    target_classifier = EncoderDecoder_basis(encoder=encoder, decoder=target_decoder, basis_vec = basis_vec, sparse_weight_vec = sparse_weight_vec, sparse_weight_vec_flag = sparse_weight_vec_flag, normalize_flag=normalize_flag, testing_drug_len = kwargs['testing_drug_len'], inv_temp = inv_temp).to(
        kwargs['device'])
